...
$gameSystem._trspupSprData._cx = this._treasureIcons._cx;
$gameSystem._trspupSprData._cy = this._treasureIcons._cy;
$gameSystem._trspupSprData._wait = this._treasureIcons._wait;
};
};
...
this._treasureIcons.push(new TreasureIcons(null,$gameSystem._trspupSprData,i,$gameSystem._trspupSprData.length));
this._treasureField.addChild(this._treasureIcons);
};
$gameSystem._trspupSprData = null;
};
...
this._treasureIcons.push(new TreasureIcons($gameSystem._trspupData,null,i,$gameSystem._trspupData.length));
...
for (i = 0; i < this._treasureIcons.length; i++){
if (this._treasureIcons.opacity === 0 && this._treasureIcons._wait[1] <= 0) {
this._treasureField.removeChild(this._treasureField);
