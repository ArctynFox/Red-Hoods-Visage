//=============================================================================
// sound sepher Engine - Battle Speed Up (Shift키 수정버전)
 ...
 * Web ：http://sepher.jp/
 * 수정자 : 베지테리안_카카 오
 * 수정사항 : ok(Enter)키 입력 대신 Shift키 입력을 받아 가속하도록 수정
 *
 * ------------------------------------------------------------------------------
 * ■内容説明
 * ------------------------------------------------------------------------------
 ...
 * ■使い方
 * ------------------------------------------------------------------------------
 * shiftボタンを押しっぱなしにすると戦闘が早送りモードになります。
 * 
 ...
 * ■パラメータの説明
 * ------------------------------------------------------------------------------
 * ・BattleSpeed (Default)：shiftボタンを押していないときの戦闘速度の倍数です。
 * ・BattleSpeed (Boost)　：shiftボタンを押してあるときの戦闘速度の倍数です。
 * 　　　　　　　　　　　 　4倍速以上は効果がありません。
 * ------------------------------------------------------------------------------
 ...
 * @desc 決定(shift)キー入力時のアニメスピードです。初期値は2。
 * 武器攻撃以外のアニメ速度を指定の倍数分、早くします。
 * @default 2
...
Sprite_Weapon.prototype.animationWait = function() {
	...
	if (Input.isPressed('shift') || TouchInput.isPressed()){
